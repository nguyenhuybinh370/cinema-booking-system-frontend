      ...
      {staffList.length === 0 || activeShifts.length === 0 ? (
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select required
              className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 focus:outline-none focus:border-red-500 text-slate-300 text-sm font-bold"
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              >
                <option value="" className="bg-[#0f1117]">Không lặp</option>
                <option value={1} className="bg-[#0f1117]">Hàng tuần</option>
                <option value={2} className="bg-[#0f1117]">Hàng ngày</option>
              </select>
            </div>
            {/* End date for repeat */}
            <div className="space-y-2">
              ...
              <input type="date"
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 focus:outline-none focus:border-red-500 text-slate-300 text-sm font-mono disabled:opacity-30 disabled:cursor-not-allowed"
